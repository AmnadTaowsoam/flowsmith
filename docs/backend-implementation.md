# FlowSmith Backend Implementation Specification
...
- Database: PostgreSQL for workflows, runs, steps, secrets refs, audit.
- Queue: Durable workflow execution jobs.
...
- workspace_id
- name
- domain: 'workflow automation building'
- status
- owner_user_id
- metadata_json
- created_at
...
1. Create project for workflow automation building.
...
- Worker can complete the primary workflow automation building workflow using sample inputs.
