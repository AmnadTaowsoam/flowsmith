# FlowSmith Environment And Configuration
...
PORT=4308
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/flowsmith
APP_BASE_URL=http://localhost:4308
...
OBJECT_STORAGE_BUCKET=flowsmith-artifacts
GITHUB_TOKEN=
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
SENTRY_DSN=
